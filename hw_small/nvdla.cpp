...
RTLflow rtlflow(NUM_TESTBENCHES);
...
public:
	CSBMaster(VNV_nvdla *_dla, int idx) {
		dla = _dla;
    idx = idx;
...
int main(int argc, const char **argv, char **env) {
  ...
  std::vector<TraceLoader*> trace(NUM_TESTBENCHES);
  std::vector<CSBMaster*> csb(NUM_TESTBENCHES);
  std::vector<AXIResponder*> axi_dbb(NUM_TESTBENCHES);
  std::vector<AXIResponder*> axi_cvsram(NUM_TESTBENCHES);

  Verilated::commandArgs(argc, argv);
  if (argc != (NUM_TESTBENCHES)) {
